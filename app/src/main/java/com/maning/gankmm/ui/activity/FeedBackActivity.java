...
public class FeedBackActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SkinManager.THEME_DAY == currentSkinType) {
            initToolBar(toolbar, getString(R.string.gank_page_title_feedback), R.drawable.icon_arrow_back);
        } else {
            initToolBar(toolbar, getString(R.string.gank_page_title_feedback), R.drawable.icon_arrow_back_night);
        }
